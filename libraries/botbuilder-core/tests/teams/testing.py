...
def aux_deserializer(msrest_cls: Type[Model], dict_to_deserialize: dict) -> Model:
    dependencies = [
        schema_cls
...
result = aux_deserializer(teams_schema.MessagingExtensionAction, {"botActivityPreview": [
                        {"id": "123"},
                        {"id": "abc"}
                        ]
                        })
